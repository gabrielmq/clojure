...
(facts "Dá um 'Hello World' na rota raiz"
       (let [response (app (mock/request :get "/"))]
         ...
         (fact "o texto do corpo é 'Helo World'"
...
(facts "Saldo inicial é 0"
       ...
       (let [response (app (mock/request :get "/saldo"))]
         ...
         (fact "o texto do corpo é é um JSON cuja chave é saldo e o valor é 0"
...
(facts "Existe rota para lidar com filtro de transações por tipo"
       (against-background
