...
(facts "Filtra transações por rótulo"
       ...
       (against-background
         ...
         (fact "encontra as 2 transações com rótulo 'educação'"
               (transacoes-com-filtro {:rotulos ["educação"]}) => '({:rotulos ["livro" "educação"] :tipo "despesa" :valor 88.0M}
                                                                    {:rotulos ["curso" "educação"] :tipo "despesa" :valor 106.0M}))
